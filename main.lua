...
function love.draw()
    ...
    love.graphics.printf("Score: " .. score, 0, love.graphics.getHeight()-100, love.graphics.getWidth(), "left")
    love.graphics.printf("Life: " .. life, 0, love.graphics.getHeight()-100, love.graphics.getWidth(), "right")
